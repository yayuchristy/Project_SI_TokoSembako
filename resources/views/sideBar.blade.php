    ...
    <div class="d-flex flex-column">
      <nav id="navbar" class="nav-menu navbar">
        <ul>
          ...
          <li><a href="#hero" class="nav-link scrollto "><i class="bx bx-user"></i> <span>Lihat Data Karyawan</span></a></li>
          <li><a href="#about" class="nav-link scrollto"><i class="bx bx-user"></i> <span>Input Data Karyawan</span></a></li>
          <li><a href="#resume" class="nav-link scrollto"><i class="bx bx-user"></i> <span>Edit Data Karyawan</span></a></li>
          <li><a href="#portfolio" class="nav-link scrollto"><i class="bx bx-user"></i> <span>Hapus Data Karyawan</span></a></li>
          <li><a href="#services" class="nav-link scrollto"><i class="bx bx-file-blank"></i> <span>Laporan Penjualan</span></a></li>
          <li><a href="#contact" class="nav-link scrollto"><i class="bx bx-file-blank"></i> <span>Laporan Keuangan</span></a></li>
        </ul>
      </nav>
    </div>
  </header>
